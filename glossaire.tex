...
%% ARCHITECTURE %%
    ...
    \newglossaryentry{gpu}{type=\acronymtype, name={GPU}, description={Graphics Processing Unit ou processeur graphique}, first={processeurs graphiques (GPU)}}
...
%% LOGICIEL %%
    ...
    \newglossaryentry{FMA}{
        type=\acronymtype, 
        name={FMA}, 
        description={instruction processeur réalisant une addition et une multiplication entre trois valeurs a, b et c tel que $a = a + b * c$}, first={une multiplication et une addition fusionnées(FMA)}
    }
