...
\glsresetall
    ...
    \iflong
        \input{chapter/PART-contributions/chapter-developpement/section-1-introduction}\newpage
        \input{chapter/PART-contributions/chapter-developpement/section-2-dml_mem}\newpage
        \input{chapter/PART-contributions/chapter-developpement/section-3-kg}\newpage
        \input{chapter/PART-contributions/chapter-developpement/section-4-YAMB}\newpage
        \input{chapter/PART-contributions/chapter-developpement/section-5-oprofile}\newpage
        \input{chapter/PART-contributions/chapter-developpement/section-6-conclusion}
    \else
        %\input{chapter/PART-contributions/chapter-developpement/section-5-oprofile}\newpage
    \fi 
