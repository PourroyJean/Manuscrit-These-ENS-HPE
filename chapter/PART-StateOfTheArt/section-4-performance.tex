...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \paragraph{Perfmon2}\label{sec:edl_profiling_perfmon2}
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \paragraph{Pseudo système de fichier \texttt{/dev/cpu/CPUID/msr}}\label{sec:edl_profiling_dev_cpu}
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{verbatim}
        ...
        \paragraph{PAPI \cite{Browne2000}.} \label{sec:papi}
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
